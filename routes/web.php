...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('stock/print-multiple-combo-labels', [App\Http\Controllers\Admin\PurchaseController::class, 'printMultipleComboLabels'])->name('stock.print.multiple.combo');
