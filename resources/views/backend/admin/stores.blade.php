...
<!-- Create Store -->
<div class="modal fade" id="addModal" tabindex="-1" Store="dialog">
    <div class="modal-dialog" Store="document">
        <div class="modal-content">
            <form action="{{ route('stores.store')}}" method="post" enctype="multipart/form-data">
                <div class="modal-header custom-modal">
                    <h4 class="modal-title" id="defaultModalLabel">Add New Store</h4>
                </div>
...
<!-- Edit Modal -->
<div class="modal fade" id="editModal" tabindex="-1" Store="dialog">
    <div class="modal-dialog" Store="document">
        <div class="modal-content">
            <form class="edit-form" method="post" enctype="multipart/form-data">
                <div class="modal-header custom-modal">
                    <h4 class="modal-title" id="defaultModalLabel">Edit Store</h4>
                </div>
                <div class="modal-body">
                    @csrf
                    @method('PUT')
...
$( ".edit" ).click(function( event ) {
    var id = $(this).data('id');
    var update_url = location.origin + "/stores/" + id;
    var url = location.origin + '/stores/' + id;
...
$( ".delete" ).click(function() {
    ...
    var url=location.origin+'/stores/'+data_id;
