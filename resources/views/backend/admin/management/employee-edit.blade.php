...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{ route('management.employees') }}" class="btn btn-primary waves-effect pull-right" style="margin-bottom:10px;" >
                ...
                <div class="body table-responsive">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <form action="{{ route('management.employees.update', $employee->id) }}" method="post" id="emplyeeForm">
                                    @csrf
