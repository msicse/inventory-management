        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        All Statuses
                        <span class="badge ">{{ $statuses->count() }}</span>
                    </h2>
        ...
        <div class="modal-content">
            <form action="{{ route('statuses.store')}}" method="post" enctype="multipart/form-data">
                <div class="modal-header custom-modal">
                    <h4 class="modal-title" id="defaultModalLabel">Add New Status</h4>
                </div>
...
$( ".edit" ).click(function( event ) {
    var id = $(this).data('id');
    var update_url = location.origin + "/statuses/" + id;
    var url = location.origin + '/statuses/' + id;
...
$( ".delete" ).click(function() {
    ...
    var url=location.origin+'/statuses/'+data_id;
